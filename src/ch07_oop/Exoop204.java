 ...
 *Food, Fruit, Drink, Snack, Apple,Peach,Coke,Cider,Biscuit,Cookie 클래스 10개 구현하기
 *	
 */
	...
	public static void main(String[] args) {
		...
		Cider cider = new Cider(1500,1000);//가격 , 용량
		Biscuit bis = new Biscuit(10000,500); //가격, 무게
...
class Coke extends Drink {
	int ml;
	Coke(int price,int ml) { super(price,ml);		this.ml=ml;	}
	@Override
	public String toString() {
		return "콜라";
	}
