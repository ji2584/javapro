...
public class MapEx1 {
	...
	public static void main(String[] args) {
		...
		for(String k : keys) {System.out.println(k + "의 번호:" + map.get(k));
		
		//Value값들만 조회
		System.out.println("Value값들만 조회");
		Collection<Integer>values = map.values();//=>Key값 조회불가.
		//values ==> Collection
		...
		Set<Map.Entry<String, Integer>> entry = map.entrySet();//map entry
