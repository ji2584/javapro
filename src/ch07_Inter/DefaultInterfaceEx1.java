...
public class DefaultInterfaceEx1 {
	/*
	 * jdk.8.0이후에 인터페이스도 구현부를 가진 메서드를 멤버로 가질 수 있다.
	 * 	default 메서드 : 인스턴스멤버
...
interface MyInterface2{ 
	void method();
	default void method1() {
		System.out.println("Myinterface2의 디폴트 메서드 : method()");
	}
	static void staticMethod() {
...
class Child extends Parent implements MyInterface2,MyInterface1 {
	...
	@Override
	public void method1() {
		System.out.println("Child 클래스 method1() 메서드");	}

	@Override
	public void method() {
		System.out.println("Child 클래스의 method()");
		System.out.println("MyInterface1, MyInterface2 인터페이스 의 추상메서드 method 오버라이딩함");
	}
