...
public class StringEx1 {
	...
	else 				System.out.println("s3.equals(s2) : 다른내용");
	
	if(s2 == s3)	System.out.println("s2==s3 : 같은객체");
	else 		System.out.println("s2==s3 : 다른객체");
	
	if(s2.equals(s3)) System.out.println("s2.equals(s3) : 같은 내용");
	else 				System.out.println("s2.equals(s3) : 다른내용");
