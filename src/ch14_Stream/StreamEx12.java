...
public class StreamEx12 {
	...
	public static void main(String[] args) {
			...
			System.out.println("영어 점수 역순으로 정렬하며 출력하기 : 람다방식");
			...
			System.out.println("수학 점수 역순으로 정렬하며 출력하기 : 람다방식");
			list.stream()
			.sorted((s1,s2)-> s2.getMath()-s1.getMath())
			.forEach(System.out::println);

			System.out.println("합계 점수 역순으로 정렬하며 출력하기 : 람다방식");
			list.stream()
...
class Student2 implements Comparable<Student2> {
	...
	public int compareTo(Student2 o) {
		...
		return score-o.score; // a-b => 기본형 a.compareTo(b) => 참조형일때 
	}
